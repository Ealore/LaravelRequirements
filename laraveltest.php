    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php if (version_compare(PHP_VERSION, LARAVEL_PHP_VERSION) >= 0) {
                ?>
                <div class="alert alert-success" role="alert">The minimum PHP version supported is <?php echo LARAVEL_PHP_VERSION;
                ?>, this server is running version <?php echo PHP_VERSION;
                ?></div>
                <?php
            } else {
                ?>
                <div class="alert alert-warning" role="alert">The minimum PHP version supported is <?php echo LARAVEL_PHP_VERSION ?>', this server is running version <?php echo PHP_VERSION;
                ?></div>
                <?php
            } ?>
        </div>
        ...
        <div class="row">
            ...
            <?php if (OPENSSL_VERSION_TEXT) {
                ?>
                <div class="alert alert-success" role="alert">OpenSSL PHP extension available in version <?php echo str_replace('OpenSSL', '', OPENSSL_VERSION_TEXT);
                ?></div>
                <?php
            } else {
                ?>
        ...
        <div class="row">
            ...
            <?php if ($pdo = phpversion('pdo')) {
                ?>
                <div class="alert alert-success" role="alert">PDO PHP extension available in version <?php echo $pdo;
                ?></div>
                <?php
            } else {
                ?>
        ...
        <div class="row">
            ...
            <?php if ($pdo_sqlite = phpversion('pdo_sqlite')) {
                ?>
                <div class="alert alert-success" role="alert">PDO_SQLite PHP extension available in version <?php echo $pdo_sqlite;
                ?></div>
                <?php
            } else {
                ?>
        ...
        <div class="row">
            ...
            <?php if ($mbstring = mb_get_info('internal_encoding')) {
                ?>
                <div class="alert alert-success" role="alert">Mbstring PHP extension available with internal encoding set to <?php echo $mbstring;
                ?></div>
                <?php
            } else {
                ?>
        ...
        <div class="row">
            ...
            <?php if ($tokenizer = phpversion('tokenizer')) {
                ?>
                <div class="alert alert-success" role="alert">Tokenizer PHP extension available in version <?php echo $tokenizer;
                ?></div>
                <?php
            } else {
                ?>
